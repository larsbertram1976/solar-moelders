...
export function ProcessSteps() {
  return (
    <section id="so-funktionierts" className="bg-white">
      <div className="container mx-auto px-4 py-16 md:px-6 md:py-24">
        ...
        <ol className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {processSteps.map((step, index) => (
            ...
            >
              <div className="absolute -top-4 left-6 flex h-8 w-8 items-center justify-center rounded-full bg-primary text-sm font-bold text-primary-foreground shadow-md">
                {index + 1}
              </div>
